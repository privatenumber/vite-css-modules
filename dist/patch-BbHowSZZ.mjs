...
const patchCssModulesConfigSymbol = Symbol.for("vite-css-modules.patch-config");
...
const patchCssModules = (patchConfig) => {
  ...
  const plugin = {
    ...
    configResolved: (config) => {
      ...
      const viteCssPostPluginIndex = config.plugins.findIndex((plugin2) => plugin2.name === "vite:css-post");
...
export { pluginName as a, patchCssModulesConfigSymbol as b, cssModules as c, cleanUrl as d, getCssModuleUrl as e, generateTypes as f, getLocalesConventionFunction as g, patchCssModules as p, shouldKeepOriginalExport as s };
