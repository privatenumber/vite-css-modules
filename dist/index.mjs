...
const importsToCode = (imports, allowArbitraryNamedExports = false) => Array.from(imports).map(
...
const exportsToCode = (exports, allowArbitraryNamedExports = false) => {
...
const generateEsm = (imports, exports, allowArbitraryNamedExports = false) => importsToCode(imports, allowArbitraryNamedExports) + exportsToCode(exports, allowArbitraryNamedExports);
const dtsComment = `
/**
