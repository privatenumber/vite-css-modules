...
const getViteConfig = async (root, configFile) => {
  ...
  if (!viteConfig.configFile) {
    throw new Error(
      `Vite config file not found${root ? ` in ${root}` : ""}. Ensure you have a valid Vite config in the ${root ? "specified" : "current working"} directory.`
    );
  }
...
exports.isConfigCaptureEnabled = isConfigCaptureEnabled;
