...
const cssModules = (config) => {
  ...
  const loadTransformer = isLightningCss ? Promise.resolve().then(function () { return require('./lightningcss-cbed3ada.cjs'); }) : Promise.resolve().then(function () { return require('./index-01918dea.cjs'); });
