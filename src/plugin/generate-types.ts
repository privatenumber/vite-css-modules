...
const getDtsHeaderLines = (
	headerMetadataLine?: string,
) => [
	'/* eslint-disable */',
	'/* prettier-ignore */',
	'// @ts-nocheck',
...
const getDtsHeaderLineCount = (
	headerMetadataLine?: string,
) => getDtsHeaderLines(headerMetadataLine).length + 1;
...
export const generateTypes = (
	...
	if (exportedVariables.length === 0) {
		return dtsTemplate(undefined, undefined, headerMetadataLine);
	}
